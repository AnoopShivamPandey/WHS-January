...
public class OfferFoodSubCategory implements Serializable{
    ...
    public ArrayList<OfferFoodMenuItem> getOfferFoodItems() {
        return offerFoodItems;
    }

    public void setOfferFoodItems(ArrayList<OfferFoodMenuItem> offerFoodItems) {
        this.offerFoodItems = offerFoodItems;
    }

    @SerializedName("offer_food_items")
    @Expose
    public ArrayList<OfferFoodMenuItem> offerFoodItems;
