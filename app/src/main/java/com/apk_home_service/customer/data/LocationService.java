        ...
        public void onLocationResult(LocationResult locationResult) {
            for (Location location : locationResult.getLocations()) {
                ...
                if (location.hasAccuracy()) {
                    ...
                    com.apk_home_service.customer.utill.Constants.savePreferences(getApplicationContext(), com.apk_home_service.customer.utill.Constants.LATITUDE, location.getLatitude() + "");
                    com.apk_home_service.customer.utill.Constants.savePreferences(getApplicationContext(), com.apk_home_service.customer.utill.Constants.LONGITUDE, location.getLongitude() + "");
                    try {
...
//                    if(/*isBetterLocation(location,previousLocation) &&*/ /*location.getSpeed()>3 *//*&& previousLocation.distanceTo(currentLocation)>15*//* &&*/ location.getAccuracy()<=15)
                    if (location.getAccuracy() <= 20) {
                        ...
                        Intent intent1 = new Intent("LOCATION_ACTION");
