package com.apk_home_service.customer.data;
...
public class Constants {
    ...
    public static final String PREF_KEY = "DOWPref";
    ...
    public static String USER_GENERAL_SETTINGS = "USER_GENERAL_SETTINGS";
    public static String TENDER_BOOKING_DETAILS = "USER_GENERAL_SETTINGS";
    ...
    public static void storeGeneralSettings(Context context, JSONObject jsonObject) {
        savePreferences(context, USER_GENERAL_SETTINGS, jsonObject.toString());
    }

    public static String getGeneralSettings(Context context) {
        return getSavedPreferences(context, USER_GENERAL_SETTINGS, "");
    }
